...
const _OMER_WEEKS = ['','שָׁבוּעַ אֶחָד','שְׁנֵי שָׁבוּעוֹת','שְׁלֹשָׁה שָׁבוּעוֹת','אַרְבָּעָה שָׁבוּעוֹת','חֲמִשָּׁה שָׁבוּעוֹת','שִׁשָּׁה שָׁבוּעוֹת','שִׁבְעָה שָׁבוּעוֹת'];
...
function buildOmerText(day) {
  ...
  return [
    ...
    { type: 'muted', text: 'הִנְנִי מוּכָן וּמְזֻמָּן לְקַיֵּם מִצְוַת עֲשֵׂה שֶׁל סְפִירַת הָעֹמֶר, כְּמוֹ שֶׁכָּתוּב בַּתּוֹרָה: וּסְפַרְתֶּם לָכֶם מִמָּחֳרַת הַשַּׁבָּת מִיּוֹם הֲבִיאֲכֶם אֶת עֹמֶר הַתְּנוּפָה, שֶׁבַע שַׁבָּתוֹת תְּמִימֹת תִּהְיֶינָה. עַד מִמָּחֳרַת הַשַּׁבָּת הַשְּׁבִיעִת תִּסְפְּרוּ חֲמִשִּׁים יוֹם, וְהִקְרַבְתֶּם מִנְחָה חֲדָשָׁה לַיהֹוָה.' },
    // ויהי נועם – תהלים צ:יז
    { type: 'muted', text: 'וִיהִי נֹעַם אֲדֹנָי אֱלֹהֵינוּ עָלֵינוּ, וּמַעֲשֵׂה יָדֵינוּ כּוֹנְנָה עָלֵינוּ, וּמַעֲשֵׂה יָדֵינוּ כּוֹנְנֵהוּ.' },
    { type: 'spacer' },
    ...
    // למנצח – תהלים סז
    { type: 'psalm-title', text: 'לַמְנַצֵּחַ בִּנְגִינֹת מִזְמוֹר שִׁיר:' },
    { type: 'text', text: 'אֱלֹהִים יְחָנֵּנוּ וִיבָרְכֵנוּ, יָאֵר פָּנָיו אִתָּנוּ סֶלָה.' },
    { type: 'text', text: 'לָדַעַת בָּאָרֶץ דַּרְכֶּךָ, בְּכָל גּוֹיִם יְשׁוּעָתֶךָ.' },
    { type: 'text', text: 'יוֹדוּךָ עַמִּים אֱלֹהִים, יוֹדוּךָ עַמִּים כֻּלָּם.' },
    { type: 'text', text: 'יִשְׂמְחוּ וִירַנְּנוּ לְאֻמִּים, כִּי תִשְׁפֹּט עַמִּים מִישׁוֹר, וּלְאֻמִּים בָּאָרֶץ תַּנְחֵם סֶלָה.' },
    { type: 'text', text: 'יוֹדוּךָ עַמִּים אֱלֹהִים, יוֹדוּךָ עַמִּים כֻּלָּם.' },
    { type: 'text', text: 'אֶרֶץ נָתְנָה יְבוּלָהּ, יְבָרְכֵנוּ אֱלֹהִים אֱלֹהֵינוּ.' },
    { type: 'text', text: 'יְבָרְכֵנוּ אֱלֹהִים, וְיִירְאוּ אוֹתוֹ כָּל אַפְסֵי אָרֶץ.' },
    { type: 'spacer' },

    // אנא בכח – 7 שורות + ברוך שם בסוף (בלחש)
    { type: 'psalm-title', text: 'אָנָּא בְּכֹחַ:' },
    { type: 'text', text: 'אָנָּא בְּכֹחַ גְּדֻלַּת יְמִינְךָ, תַּתִּיר צְרוּרָה.' },
    { type: 'text', text: 'קַבֵּל רִנַּת עַמְּךָ, שַׂגְּבֵנוּ טַהֲרֵנוּ נוֹרָא.' },
    { type: 'text', text: 'נָא גִבּוֹר, דּוֹרְשֵׁי יִחוּדְךָ כְּבָבַת שָׁמְרֵם.' },
    { type: 'text', text: 'בָּרְכֵם טַהֲרֵם, רַחֲמֵי צִדְקָתְךָ תָּמִיד גָּמְלֵם.' },
    { type: 'text', text: 'חֲסִין קָדוֹשׁ, בְּרֹב טוּבְךָ נַהֵל עֲדָתֶךָ.' },
    { type: 'text', text: 'יָחִיד גֵּאֶה, לְעַמְּךָ פְּנֵה זוֹכְרֵי קְדֻשָּׁתֶךָ.' },
    { type: 'text', text: 'שַׁוְעָתֵנוּ קַבֵּל, וּשְׁמַע צַעֲקָתֵנוּ יוֹדֵעַ תַּעֲלוּמוֹת.' },
    { type: 'muted', text: '(בלחש) בָּרוּךְ שֵׁם כְּבוֹד מַלְכוּתוֹ לְעוֹלָם וָעֶד.' },
    { type: 'spacer' },
    ...
    // עלינו לשבח
    { type: 'psalm-title', text: 'עָלֵינוּ לְשַׁבֵּחַ:' },
    { type: 'text', text: 'עָלֵינוּ לְשַׁבֵּחַ לַאֲדוֹן הַכֹּל, לָתֵת גְּדֻלָּה לְיוֹצֵר בְּרֵאשִׁית, שֶׁלֹּא עָשָׂנוּ כְּגוֹיֵי הָאֲרָצוֹת, וְלֹא שָׂמָנוּ כְּמִשְׁפְּחוֹת הָאֲדָמָה. שֶׁלֹּא שָׂם חֶלְקֵנוּ כָּהֶם, וְגוֹרָלֵנוּ כְּכָל הֲמוֹנָם. שֶׁהֵם מִשְׁתַּחֲוִים לְהֶבֶל וָרִיק וּמִתְפַּלְּלִים אֶל אֵל לֹא יוֹשִׁיעַ.' },
...
async function showOmerNow() {
  ...
  contentEl.innerHTML = sections.map(s => {
    ...
    if (s.type === 'psalm-title') return `<p style="${baseStyle};color:var(--gold-dim);font-size:calc(var(--font-size)*.82);font-weight:600;margin-top:4px;margin-bottom:2px">${s.text}</p>`;
